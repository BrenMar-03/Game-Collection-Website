...
<head>
    ...
    <title>GameSpawn – Add New User</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .photo-preview svg { color: var(--muted); }
        .photo-upload-btn {
            background: var(--surface2); border: 1px dashed var(--border);
            color: var(--muted); padding: 10px 16px; border-radius: var(--radius);
        ...
        .form-footer {
            ...
            background: #16181b; border-top: 1px solid var(--border);
        }
        .btn-cancel {
...
<main>
    ...
    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-footer" style="border-radius:0 0 12px 12px; background:var(--surface); border:1px solid var(--border); border-top: 1px solid var(--border); margin-top:-1px; padding:20px 28px; display:flex; justify-content:flex-end; gap:12px;">
